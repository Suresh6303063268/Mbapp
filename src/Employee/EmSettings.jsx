...
import EmDash from './EmainDash.jsx';
...
function Notification() {
  ...
  return (
    <div>
      <EmDash/>
      <div className='adi' style={{ width: 1100, height: 600, border: '1px solid grey', backgroundColor: '', marginTop: 150, marginLeft: 200, boxShadow: '0px 0px 5px black' }}>
