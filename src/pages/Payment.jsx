...
const steps = ['Fill OTR', 'Apply job', 'Payment', 'Confrom Payment','Applied jobs'];
...
export default function HorizontalLinearStepper() {
  ...
  const validateForm = () => {
    ...
    Object.keys(formData).forEach((key) => {
      if (!formData[key]) {
        newErrors[key] = 'This field is required details';
      }
    });
    return newErrors;
  };
  ...
  const getStepContent = (step) => {
    switch (step) {
      case 0:
        return (
          <Box>
            <div style={{ border: '1px solid black', width: 780, height: 450, borderRadius: 20,marginTop:40,boxShadow: '0px 0px 5px black',marginLeft:50}}>
            <p style={{ paddingTop:25, fontWeight:700,fontSize:30, textAlign:'center'}}>Medical & Health Department</p>
              <p style={{ paddingLeft: 40, paddingTop:30, fontWeight:700 }}>POST NAME:</p>
              <p style={{ paddingLeft: 140, marginTop: -40, fontWeight:700 }}>Arogya Mitras & Team Leaders -19 POSTS</p>
              <br />
              <p style={{ paddingLeft:40, fontWeight:700 }}>Apply Through OTR</p>
              <div style={{ border: '1px solid black', width: 400, height: 60, marginLeft: 180, borderRadius: 20,marginTop:50}}>
                <div style={{ padding: 20,marginTop:-10}}>
                  <PermIdentityOutlinedIcon style={{fontSize:40}} />
                </div>
                <div className='bt1' style={{ marginTop:-60, marginLeft: 130, width:150, height:40, borderRadius: 10,paddingTop:5}}>
                  <b style={{ padding: 20, width:150,marginTop:-40,paddingTop:10}}>OTR FORM</b>
                </div>
                <div style={{ marginTop:-32, marginLeft: 350 }}>
                  <input
                    type='radio'
                    name='step1Radio'
                    value='selected'
              ...
              <div style={{ marginLeft: 300, marginTop:20 }}>
                <button style={{ backgroundColor: '#a1a09d', width: 150, height: 40, border: 'none', borderRadius: 10 }} onClick={next}>Continue</button>
              </div>
            </div>
          </Box>
        );
      ...
      case 1:
        return (
          ...
          <Box>
            <div style={{ border: '1px solid black', width:860, height: 1630, borderRadius: 20,boxShadow: '0px 0px 5px black',marginTop:50,marginLeft:30}}>
              <p style={{ paddingTop:25, fontWeight:700,fontSize:30, textAlign:'center'}}>Medical & Health Department</p>
              <p style={{ paddingLeft:150, paddingTop:50, fontWeight:700}}>POST NAME :</p>
              <p style={{ paddingLeft:280, marginTop: -40, fontWeight:400,fontSize:16}}>Arogya Mitras & Team Leaders -<span style={{color:'darkblue'}}>19 POSTS</span></p>
              <br />
              <p style={{ paddingLeft:150, fontWeight:700 }}>Apply Through OTR</p>
              <div style={{ border: '1px solid black', width: 400, height: 60, marginLeft:200,borderRadius: 20,marginTop:30}}>
                <div style={{ padding: 20 }}>
                  <PermIdentityOutlinedIcon style={{fontSize:40,marginTop:-10}}      />
                </div>
                <div className='bt1' style={{ marginTop: -75, marginLeft:100, width:200, height:40, borderRadius: 10,paddingLeft:35}}>
                  <p style={{ paddingTop:8, paddingLeft: 15, fontWeight: 700,width:250,height:50,marginTop:15}}>OTR FORM</p>
                </div>
              ...
              {/*edit button*/}
                ...
                <Box>
                  <p style={{ paddingLeft:150, marginTop: 50, fontWeight:700 }}>Your SPN ID :</p>
                  <br />
                  <div style={{ marginLeft:260, marginTop: -70 }}>
                    <button style={{ backgroundColor: '#a1a09d', width: 150, height: 40, border: 'none', borderRadius: 10, fontWeight:700 }}>ABX123XXXX</button>
                  </div>
                  <p style={{ paddingLeft:50, marginTop: 50, fontWeight:700 }}>Add Some more Details</p>
                  {/*details*/}
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>Do you have any previous employment details to share?</p>
                  <div style={{ marginLeft:65 }}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>What was the duration of your previous employment?</p>
                  <div style={{ marginLeft:65 }}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>What was your position in your previous employment?</p>
                  <div style={{ marginLeft:65 }}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>Reason for leaving previous employment?</p>
                  <div style={{ marginLeft:65}}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>Preferred exam center</p>
                  <div style={{ marginLeft:65}}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>Have you ever been convicted by any court of law?</p>
                  <div style={{ marginLeft:65}}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <p style={{ paddingLeft:50, fontWeight:700, marginTop: -5 }}>Have you ever been dismissed from service of any organization?</p>
                  <div style={{ marginLeft:65}}>
                    <input
                      style={{ width: 650, borderRadius: 10, height:50 }}
                      type='text'
                  ...
                  <br></br>
                  <input style={{marginLeft:50,marginTop:10}}         type='checkbox'/>
                  <p style={{paddingLeft:80,marginTop:-30,width:700}}>I hereby declare that all the information provided above is true to the best of my knowledge and belief.</p>
                </Box>
            </div>
            <Button
                      style={{ backgroundColor: '#00a3cc',color:'white', width: 150, height: 40, border: 'none', borderRadius: 10,marginTop:40,marginLeft:40}}
                      onClick={handleBack}
                    >
               Back
                    </Button>
            ...
            <div style={{ marginLeft: 650,}}>
                    <Button
                      style={{ backgroundColor: 'rgb(3, 62, 95)',color:'white', width: 150, height: 40, border: 'none', borderRadius: 10,marginTop:-65,marginLeft:50}}
