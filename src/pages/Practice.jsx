  ...
  return (
    <div>
      <div style={{ display: 'flex', width: 1000, height: 500, marginLeft: 100, borderRadius: 10 }}>
        ...
        <div style={{ display: 'grid', marginTop: 30,marginLeft:100}}>
          <div style={{ backgroundColor: 'blue', width: 300, height: 120, color: 'white', border: 'none', borderRadius: 10, textAlign: 'center', paddingTop: 30,boxShadow: '0px 0px 5px black',fontSize:20,fontWeight:'bold'}}>
            Admit cards received <br /> {admitReceived}
          </div>
          <br />
          <div style={{ backgroundColor: 'blue', width: 300, height: 120, color: 'white', border: 'none', borderRadius: 10, marginTop: -80, textAlign: 'center', paddingTop: 30,boxShadow: '0px 0px 5px black', fontSize:20,fontWeight:'bold'}}>
