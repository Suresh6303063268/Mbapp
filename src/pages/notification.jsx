...
<Header/>
    ...
    <div style={{display: 'flex', justifyContent: 'center' , marginTop: 170}}>
      <MdNotificationsActive style={{fontSize: 50, paddingTop: 8, marginRight: 25}}/>
      <h1 style={{fontSize: 35, textDecoration: 'underline',fontWeight:'bold'}}>Notifications</h1>
    </div>
