...
<div style={{marginTop:150, backgroundColor: 'whitesmoke',borderRadius: 10,boxShadow: '2px 4px 5px'}}>
<h1 style={{
  fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue, sans-serif',
...
<section>
  ...
  textDecoration: 'underline',paddingLeft: '20', marginTop:40, fontSize:20}}>2023</h1>
    <div style={{marginTop:80, backgroundColor: 'whitesmoke',borderRadius: 10,margin: 10,boxShadow: '2px 4px 5px'}}>
<h1 style={{
  fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue, sans-serif',
