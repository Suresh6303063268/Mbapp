...
{/*otr form responces*/}
      ...
      <div className={`otr ${activeTab === 'OTR' ? 'active' : ''}`} id="OTR">
        ...
        <div style={{marginLeft:-13,marginTop:-3}}>
          ...
          <div style={{marginTop:-398,marginLeft:400}}>
        ...
        <div>
          <span>{text}</span>
          <br></br>
          <button className='edit'  onClick={handleEdit} style={{ marginLeft: '388px',height:'46px',width:'80px' }}>
            Edit
          </button>
...
{/*pqp responces*/}
      <div className={`pqp ${activeTab === 'PQP' ? 'active' : ''}`} id="PQP">
        <b style={{paddingLeft:30}}>PQP</b>
        <br></br>
    {/*search button*/}
        <input style={{marginLeft:30,marginTop:40,height:40,width:220,borderRadius:10}}type='search' placeholder='Search Target Exam'/>
      ...
      <p style={{marginLeft:30,width:50,fontWeight:1000}}>Popular Exam</p>
        <br></br>

        {/*main boxes*/}
        <div style={{display:'flex'}}>
          {/*Ssc*/}
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:35,paddingLeft:20}}>
              <img style={{width:80,height:40}} src={Img5} alt='Img5'/>
            </div>
            <div style={{paddingTop:35,paddingLeft:20}} >
              <p>SSC</p>
            </div>
        ...
        {/*defence Exam*/}
           <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:-10}}>
              <img style={{width:120,height:70}} src={Img6} alt='Img6'/>
            </div>
            <div style={{paddingTop:25}} >
              <p>Defense</p>
              <p style={{paddingLeft:10,marginTop:-10}}>Exam</p>
            </div>
          </div>
        </div>
      ...
      {/*Banking exam*/}
        <div style={{display:'flex'}}>
          ...
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:20}}>
              <img style={{width:80,height:80}} src={Img7} alt='Img7'/>
            </div>
        ...
        {/*Railways exam*/}
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:20}}>
              <img style={{width:80,height:80}} src={Img8} alt='Img8'/>
            </div>
            <div style={{paddingTop:30,paddingLeft:20}} >
              <p>Railway Exam</p>
            </div>
        ...
        {/*defence Exam*/}
           <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:20}}>
              <img style={{width:80,height:80}} src={Img9} alt='Im9'/>
            </div>
  ...
  {/*3rd row*/}
      ...
      <br></br>
          ...
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:20}}>
              <img style={{width:80,height:80}} src={Img10} alt='Img10'/>
            </div>
            <div style={{paddingTop:35,paddingLeft:20}} >
              <p>Teaching Exams</p>
        ...
        {/*Railways exam*/}
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:45,paddingLeft:20}}>
              <img style={{width:80,height:40}} src={Img11} alt='Img11'/>
            </div>
        ...
        {/*defence Exam*/}
           <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:20}}>
              <img style={{width:80,height:80}} src={Img13} alt='Img13'/>
            </div>
            <div style={{paddingTop:30,paddingLeft:15}} >
              <p>Police Exam</p>
            </div>
      ...
      <br></br>
          ...
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:20}}>
              <img style={{width:80,height:80}} src={Img14} alt='Img14'/>
            </div>
            <div style={{paddingTop:20,paddingLeft:20}} >
              <p>Insurance Exam</p>
        ...
        {/*defence Exam*/}
           <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:35,paddingLeft:20}}>
              <img style={{width:80,height:50}} src={Img16} alt='Img16'/>
            </div>
        ...
        <div style={{display:'flex'}}>
          ...
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,paddingLeft:10}}>
              <img style={{width:100,height:60}} src={Img17} alt='Img17'/>
            </div>
        ...
        {/*Railways exam*/}
          ...
          {/*defence Exam*/}
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:25,marginLeft:-20}}>
        ...
        <div style={{display:'flex'}}>
          ...
          <div style={{backgroundColor:'#bcc0c2', display:'flex',width:200,height:120,marginLeft:30}}>
            <div style={{paddingTop:35,paddingLeft:20}}>
              <img style={{width:90,height:60}} src={Img20} alt='Img20'/>
            </div>
            <div style={{paddingTop:20,paddingLeft:5}} >
              <p>Accounting and Commerce</p>
