...
const Admitdelivery = () => {
  ...
  return (
    <div style={{width:1180,background:'#e6ffe6'}}>
      {/* Your existing JSX */}
...
<img src={Image} alt='' style={{ height:250, width:250, float: 'right', marginTop:10, marginRight:60, borderRadius:50,boxShadow: '0px 0px 5px #c2f0f0'}} />
      ...
      <h1 style={{ color: 'red',textAlign:'center', fontSize: 25, fontWeight:'bold',marginLeft:200,marginTop:100}}>Admit Card Delivery Details</h1>
      <select style={{ marginLeft:390, width:300, height:50, borderRadius: 10, fontSize:20, paddingLeft: 50,marginTop:20,boxShadow:'0px 0px 3px black',fontWeight:'bold'}} value={selectedState} onChange={handleStateChange}>
      ...
      <button style={{ color: 'white', backgroundColor: '#EF199A', width: 150, height: 45, border: 'none', borderRadius: 6, fontWeight: 'bold', marginLeft: 460, marginTop: 20,boxShadow:'0px 0px 5px black',fontSize:20}} onClick={handleSubmit}>
        Submit
      </button>

      <div style={{ width:1130, height:40, marginLeft:20, color: 'red', backgroundColor: '#C0C0C0', marginTop: 40, fontSize: 20, fontWeight: 'bold', textAlign: 'center' }}>
        {selectedState}
      </div>

    {/* <Practice state={selectedState} data={data} options={options} /> */}

    <div style={{ maxWidth: '1100px', marginTop: 40, marginLeft: 30 }}>
  <table className='table1' style={{ width: '100%', tableLayout: 'fixed' }}>
    <thead style={{ position: 'sticky', top: 0, zIndex: 1, background: 'darkorange' }}>
      <tr className='tr1' style={{ height: '50px' }}>
        <th className='tr' style={{ width: '180px' }}>Admit Card Received</th>
        <th className='tr1' style={{ width: '170px' }}>Admit Card Delivered</th>
        <th className='tr1' style={{ width: '170px' }}>Admit Card Pending</th>
        <th className='tr1' style={{ width: '160px' }}>Csc Center Name</th>
        <th className='tr1' style={{ width: '150px' }}>Contact Number</th>
      </tr>
    </thead>
    <tbody style={{ maxHeight: '400px', overflowY: 'auto', background: 'white' }}>
      {tableData.map((item, index) => (
        <tr key={index}>
          <td className='adi1-box1' style={{ width: '180px' }}>{item.received}</td>
          <td className='adi-box1' style={{ width: '170px' }}>{item.delivered}</td>
          <td className='adi-box1' style={{ width: '170px' }}>{item.pending}</td>
          <td className='adi-box2' style={{ width: '160px' }}>{item.centerName}</td>
          <td className='adi-box2' style={{ width: '150px' }}>{item.contact}</td>
        </tr>
      ))}
    </tbody>
  </table>
      ...
      <div className='adi-barchart' style={{background:'white'}}>
