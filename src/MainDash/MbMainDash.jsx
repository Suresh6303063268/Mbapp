  ...
  return (
    <div className="home">
      <AppBar position="fixed">
        <Toolbar style={{ background:'linear-gradient(to left, #660066 30%, #660066 100%)', color: '#34495E', height: 80 }}>
          ...
          <div className="nav" style={{ display: 'flex', alignItems: 'center', flexGrow: 1, justifyContent: 'space-between', paddingLeft: 20 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 35, marginLeft:60, background: 'linear-gradient(to left, #cc66ff 30%, #cc66ff 100%)', width:1000,borderRadius:10}}>
              <Link to="/mbdash" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 100, textDecoration: 'none', gap: 10 }}>
                <HomeIcon className='ic1'       style={{ fontSize: 30, marginLeft: -20 }} />
                Home
              </Link>
              <Link to="" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 10, textDecoration: 'none', gap: 20 }}>
                <CalendarTodayIcon className='ic1'           style={{ fontSize: 30 }} />
                Calendar
              </Link>
              <Link to="/suryachat" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 10, textDecoration: 'none', gap: 20 }}>
                <MessageOutlinedIcon className='ic1'           style={{ fontSize: 30, marginTop: 10 }} />
                Messages
              </Link>
              <Link to="/suryasetting" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 10, textDecoration: 'none', gap: 20 }}>
                <SettingsOutlinedIcon className='ic1'           style={{ fontSize: 30 }} />
                Settings
              </Link>
            </div>
          </div>
          <div style={{ background: '#ff9966', width: 350, height:57, borderRadius:10, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px',marginTop:0,marginLeft:20}}>
            ...
            <Link to="/suryanotification" style={{ color: 'white', textDecoration: 'none' }}>
              <NotificationsActiveOutlinedIcon style={{ fontSize: 35 }} />
            </Link>
            <Link to="/suryaprofile" className="nav-link" style={{ color: 'white', textDecoration: 'none' }}>
