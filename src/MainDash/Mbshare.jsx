  ...
  return (
    <div style={{width:1200}}>
      ...
      <div style={{ display: 'flex', width:1000, height: 70, backgroundColor: '#0C0A4D', marginLeft: 70, marginTop: 20, borderRadius:10,boxShadow: '0px 0px 5px black'}}>
        <h1 style={{ color: 'white', fontSize: 20, paddingTop:20, paddingLeft:20,fontWeight:'bold',width:300}}>Admin Profile</h1>
      ...
      <div style={{ display: 'flex' }}>
        <div style={{ marginLeft: 70, marginTop: 20, width:600, height: 500,boxShadow: '0px 0px 5px black'}}>
         <div style={{width:600,height:70}}>
          ...
          <h1  style={{fontSize:20,fontWeight:'bold',paddingTop:10,paddingLeft:50,color:'white'}}>Admins<span style={{fontSize:20,fontWeight:'bold',paddingTop:0, paddingLeft:140, textDecoration:'none'}}>Active</span> <span style={{fontSize:20,fontWeight:'bold',paddingTop:20, paddingLeft:130,textDecoration:'none'}}>Message</span></h1></div>
