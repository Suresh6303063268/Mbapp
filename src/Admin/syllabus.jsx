...
const JobForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      console.log('Form submitted:', { jobCategory, jobTitle, qualification});
    } else {
      setErrors(newErrors);
    }
  };
  ...
  return (
    <form className="job-form" onSubmit={handleSubmit} style={{ marginTop: 50, boxShadow: '0px 0px 5px black', marginLeft: 200,height:600}}>
