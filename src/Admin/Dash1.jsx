  ...
  return (
    <div className="home">
     <AppBar position="fixed">
        <Toolbar style={{ background:'linear-gradient(to left, #10acaa 30%, #10acaa 100%)', color: '#34495E', height: 80 }}>
          ...
          <div className="nav" style={{ display: 'flex', alignItems: 'center', flexGrow: 1, justifyContent: 'space-between', paddingLeft: 20 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 35, marginLeft:60, background: 'linear-gradient(to left, #9eede9 30%, #9eede9 100%)', width:1000,borderRadius:10}}>
              <Link to="/dash" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 100, textDecoration: 'none', gap: 10 }}>
              ...
              <Link to="/mbchat" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 10, textDecoration: 'none', gap: 20 }}>
                <MessageOutlinedIcon className='ic1'           style={{ fontSize: 30, marginTop: 10 }} />
                Messages
              </Link>
              <Link to="/settings" className="nav-link" style={{ display: 'flex', alignItems: 'center', color: 'black', fontSize: 20, marginLeft: 10, textDecoration: 'none', gap: 20 }}>
                <SettingsOutlinedIcon className='ic1'           style={{ fontSize: 30 }} />
                Settings
              </Link>
            </div>
          </div>
          <div style={{ background: 'darkorange', width: 350, height:57, borderRadius:10, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px',marginTop:0,marginLeft:20}}>
            ...
            <Link to="/mbnotification" style={{ color: 'white', textDecoration: 'none' }}>
              <NotificationsActiveOutlinedIcon style={{ fontSize: 35 }} />
            </Link>
            <Link to="/profile1" className="nav-link" style={{ color: 'white', textDecoration: 'none' }}>
