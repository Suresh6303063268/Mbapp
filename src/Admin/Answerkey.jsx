...
const JobForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="results-form" style={{ boxShadow: '0px 0px 5px black', margin: '30px auto', width: 600, padding: 20,marginLeft:200,height:950}}>
...
<div className="results-form-group" style={{ display: 'flex', flexDirection: 'column', marginTop:10 }}>
        ...
        <select style={{ height: 50, padding: '0 10px',width:500,marginLeft:30}} value={jobCategory} onChange={(e) => setQualification(e.target.value)}>
